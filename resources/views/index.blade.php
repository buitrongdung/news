...
<head>
    ...
    <script src="{{asset('public/js/en/News.js')}}"></script>
...
<div class="header">
    ...
    <div class="header-bottom">
        <div class="logo text-center">
            <a href="index.html"><img src="{{asset('public/images/logo.jpg')}}" alt=""/></a>
        </div>
                ...
                <div class="wrap">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Entertainment<b
                                            class="caret"></b></a>
                            ...
                            <li class="dropdown">
                                <a href="business.html" class="dropdown-toggle" data-toggle="dropdown">Business<b
                                            class="caret"></b></a>
                        ...
                        <div class="search">
                            ...
                            <div class="search-box">
                                <div id="sb-search" class="sb-search">
                                    <form>
                                        <input id="search-weather" title="type &quot;a&quot;" class="sb-search-input" placeholder="Enter your search term...">
            ...
            {{--<div class="articles">--}}
                ...
                {{--<div class="article">--}}
                    {{--<div class="article-left">--}}
                        {{--<a href="single.html"><img src="{{asset('public/images/article1.jpg')}}"></a>--}}
                    {{--</div>--}}
                    {{--<div class="article-right">--}}
                        ...
                        {{--<div class="article-text">--}}
                            ...
                            {{--<a href="single.html"><img src="{{asset('public/images/more.png')}}" alt=""/></a>--}}
                            {{--<div class="clearfix"></div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<div class="clearfix"></div>--}}
                ...
                {{--<div class="article">--}}
                    {{--<div class="article-left">--}}
                        {{--<a href="single.html"><img src="{{asset('public/images/article3.jpg')}}"></a>--}}
                    {{--</div>--}}
                    {{--<div class="article-right">--}}
                        {{--<div class="article-title">--}}
                ...
                {{--<div class="article">--}}
                    {{--<div class="article-left">--}}
                        {{--<a href="single.html"><img src="{{asset('public/images/article4.jpg')}}"></a>--}}
                    {{--</div>--}}
                    {{--<div class="article-right">--}}
                        {{--<div class="article-title">--}}
