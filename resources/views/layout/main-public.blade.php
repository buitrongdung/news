    ...
    <div class="footer-top">
        <div class="wrap">
            ...
            <div class="col-md-4 col-xs-6 col-sm-6 footer-grid">
                ...
                <ul class="flickr">
                    <li><a href="#"><img src="{{asset('public/images/bus4.jpg')}}"></a></li>
                    <li><a href="#"><img src="{{asset('public/images/bus2.jpg')}}"></a></li>
                    <li><a href="#"><img src="{{asset('public/images/bus3.jpg')}}"></a></li>
                    <li><a href="#"><img src="{{asset('public/images/tec4.jpg')}}"></a></li>
                    <li><a href="#"><img src="{{asset('public/images/tec2.jpg')}}"></a></li>
                    <li><a href="#"><img src="{{asset('public/images/tec3.jpg')}}"></a></li>
                    <li><a href="#"><img src="{{asset('public/images/bus2.jpg')}}"></a></li>
                    <li><a href="#"><img src="{{asset('public/images/bus3.jpg')}}"></a></li>
                    <div class="clearfix"></div>
                </ul>
